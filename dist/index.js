...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__carousel__ = __webpack_require__(68);
...
__WEBPACK_IMPORTED_MODULE_0__carousel___default.a.install = function (Vue) {
  Vue.component('vuescroll-carousel', __WEBPACK_IMPORTED_MODULE_0__carousel___default.a);
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_array_from__ = __webpack_require__(32);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    ...
    internalActiveIndex: function internalActiveIndex(newValue) {
  ...
  computed: {
    ...
    halfClonedNodesNum: function halfClonedNodesNum() {
  ...
  methods: {
    ...
    children: function children() {
      return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_array_from___default()(this.parent.children).filter(function (i) {
        return !i.isResizeElm;
      });
    },
    ...
    fixPages: function fixPages() {
      if (this.children().length > 1) {
        ...
        this.$refs['vs'].goToPage(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()({}, this.axis, this.internalActiveIndex + this.halfClonedNodesNum), false);
      }
    },
    ...
    cloneNodes: function cloneNodes() {
      var children = this.children();
      if (children.length > 1 && this.loop) {
        // find start and end elm
        var firstChild = this.getFrist(children, function (i) {
          return !i.isResizeElm;
        });
        var lastChild = this.getLast(children, function (i) {
          return !i.isResizeElm;
        });
    ...
    removeNodes: function removeNodes(nodes, filter) {
      __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_array_from___default()(nodes).forEach(function (i) {
        if (filter(i)) {
          i.parentNode.removeChild(i);
        }
      });
    },
    getFrist: function getFrist(children, filter) {
      var i = 0;
    ...
    getLast: function getLast(children, filter) {
...
module.exports = !__webpack_require__(2) && !__webpack_require__(19)(function () {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(28), __webpack_require__(64)))
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "type": _vm.type,
      "num": _vm.realNodesWithoutCloneLen,
      "currenIndex": _vm.internalActiveIndex
    },
    on: {
      "dot-click": _vm.goToPage
    }
  })]) : _vm._e()], 2)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "dot-group",
    class: {
      'vertical': _vm.type != 'h', 'horizontal': _vm.type == 'h'
    }
  }, _vm._l((_vm.num), function(i) {
    return _c('a', {
      key: i,
      class: {
        active: _vm.currenIndex == i
      },
      attrs: {
